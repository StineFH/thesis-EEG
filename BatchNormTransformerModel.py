...
class EncoderBlock(nn.Module):
    def __init__(self, patch_length, input_dim, num_heads, dim_ff, dropout=0.0):
        """
        Args:
...
class BatchNormTransformer(pl.LightningModule):
    def __init__(
        self,
        context_size, 
        context_block,
        ...
        self.transformer = TransformerEncoder(
            ...
            patch_length=int(context_size/context_block),
